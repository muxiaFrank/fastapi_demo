...
DB_HOST = config("DB_HOST", default="10.227.21.94")
DB_PORT = config("DB_PORT", cast=int, default="3306")
DB_USER = config("DB_USER", default="eagle")
DB_PASSWORD = config("DB_PASSWORD", cast=Secret, default="iesqa")
DB_DATABASE = config("DB_DATABASE", default="eagle")
DB_DSN = config(
    "DB_DSN",
    cast=make_url,
    default=URL(
